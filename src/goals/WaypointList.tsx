...
export default function WaypointList({ waypoints, isActiveQuarter, locale }: Props) {
    const firstIncompleteIdx = isActiveQuarter
        ? waypoints.findIndex(w => w.completed_at === null)
        : -1
