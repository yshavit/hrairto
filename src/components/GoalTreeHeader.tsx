...
export default function GoalTreeHeader({
    currentQuarterLabel, entries, swimlanes, onPrev, onNext, onToday,
}: Props) {
    return (
        <header className="goal-tree-header">
            <h1 className="goal-tree-header__title">Goals</h1>
            <div className="goal-tree-header__nav">
                <button className="goal-tree-header__nav-today" onClick={onToday}>Today</button>
                <button className="goal-tree-header__nav-arrow" onClick={onPrev}>‹</button>
                <button className="goal-tree-header__nav-arrow" onClick={onNext}>›</button>
            </div>
